...
export default function PublicLayout({ children }: { children: React.ReactNode }) {
  return <div className="public-site">
    ...
    <header className="site-header">
      ...
      <nav aria-label="Main navigation"><a href="/guides">Guides</a><a href="/pricing">Pricing</a><a className="site-button small" href="/editor">Open editor <span aria-hidden="true">↗</span></a></nav>
    </header>
    {children}
    <footer className="site-footer">
      <div><a href="/" className="site-brand">PIXELWALL</a><p>A pixel-art studio by CapLock.</p></div>
      <nav aria-label="Resources"><a href="/sprite-sheet-maker">Sprite sheets</a><a href="/pixel-art-animation">Animation</a><a href="/pixel-art-tracing">Reference tracing</a><a href="/tileset-maker">Tiles &amp; maps</a></nav>
