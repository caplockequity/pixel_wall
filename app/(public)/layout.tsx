...
export default function PublicLayout({ children }: { children: React.ReactNode }) {
  return <div className="public-site">
    ...
    <footer className="site-footer">
      ...
      <nav aria-label="Resources"><a href="/downloads">Desktop downloads</a><a href="/sprite-sheet-maker">Sprite sheets</a><a href="/pixel-art-animation">Animation</a><a href="/pixel-art-tracing">Reference tracing</a><a href="/tileset-maker">Tiles &amp; maps</a></nav>
