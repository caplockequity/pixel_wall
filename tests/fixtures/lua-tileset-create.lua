...
local map=Image{width=2,height=1,colorMode=ColorMode.TILEMAP};map:drawPixel(0,0,app.pixelColor.tile(1));map:drawPixel(1,0,app.pixelColor.tile(1,0x80000000));s:newCel(layer,1,map,Point(0,0))
s:newFrame(1)
